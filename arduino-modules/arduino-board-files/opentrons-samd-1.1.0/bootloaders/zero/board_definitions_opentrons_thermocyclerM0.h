 ...
 */
#define STRING_PRODUCT "Opentrons ThermocyclerM0"
#define USB_VID_HIGH   0x04
#define USB_VID_LOW    0xD8
#define USB_PID_HIGH   0xED
#define USB_PID_LOW    0x12
...
#define BOARD_FAN_PORT                    (0)
#define BOARD_FAN_PIN                     (14)

#define BOARD_PELTIERS_PORT               (0)
#define BOARD_PELTIERS_PIN                (21)
