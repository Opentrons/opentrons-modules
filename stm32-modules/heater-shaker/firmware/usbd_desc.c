...
#define USBD_PRODUCT_HS_STRING        "Heater/Shaker HS" /* Add your product High Speed string */
#define USBD_PRODUCT_FS_STRING        "Heater/Shaker FS" /* Add your product Full Speed string */
...
#define USBD_INTERFACE_FS_STRING      "Serial Interface FS" /* Add your Interface Full Speed string */
