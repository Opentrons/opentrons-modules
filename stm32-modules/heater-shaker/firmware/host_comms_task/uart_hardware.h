...
#define UART_BUFFER_MAX_SIZE \
    64U  // sized to capture any incoming gcode
         // commands
#define UART_BUFFER_MIN_SIZE \
    16U  // threshold for determining remaining buffer size insufficient
