...
#define RS 0.46         /* Stator resistance , ohm*/
#define LS                           \
    0.000396 /* Stator inductance, H \
                      For I-PMSM it is equal to Lq */

/* When using Id = 0, NOMINAL_CURRENT is utilized to saturate the output of the
   PID for speed regulation (i.e. reference torque).
   Transformation of real currents (A) into int16_t format must be done
   accordingly with formula: Phase current (int16_t 0-to-peak) = (Phase current
   (A 0-to-peak)* 32767 * Rshunt * *Amplifying network gain)/(MCU supply
   voltage/2)
*/

#define NOMINAL_CURRENT 14237
#define MOTOR_MAX_SPEED_RPM 4110   /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT 3.1 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG -14237            /*!< Demagnetization current */
