...
#define MAX_APPLICATION_SPEED_RPM 4110 /*!< rpm, mechanical */
#define MIN_APPLICATION_SPEED_RPM \
    0 /*!< rpm, mechanical,       \
                       absolute value */
#define MEAS_ERRORS_BEFORE_FAULTS                  \
    3 /*!< Number of speed                         \
                         measurement errors before \
                         main sensor goes in fault */
/****** Hall sensors ************/
#define HALL_MEAS_ERRORS_BEFORE_FAULTS                 \
    3 /*!< Number of failed                            \
...
#define DEFAULT_CONTROL_MODE               \
    STC_SPEED_MODE /*!< STC_TORQUE_MODE or \
                     STC_SPEED_MODE */
...
#define OV_VOLTAGE_THRESHOLD_V \
    36 /*!< Over-voltage       \
                     threshold */
#define UD_VOLTAGE_THRESHOLD_V \
    5 /*!< Under-voltage       \
                      threshold */
#if 0
...
#define HW_OV_CURRENT_PROT_BYPASS                 \
    DISABLE /*!< In case ON_OVER_VOLTAGE          \
