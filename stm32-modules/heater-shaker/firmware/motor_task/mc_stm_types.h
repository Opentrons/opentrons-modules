 ...
 *
 * Each of the following symbols defines a rotation speed unit that can be used
 * by the functions of the API for their speed parameter. Each Unit is defined
 * by expressing the value of 1 Hz in this unit.
 *
 * These symbols can be used to set the #SPEED_UNIT macro which defines the
 * rotation speed unit used by the functions of the API.
 *
 * @anchor SpeedUnit
 */
/** @{ */
 ...
 *
 * This symbols defines the value of 1 Hertz in the unit used by the functions
 * of the API for their speed parameters.
 *
 * For instance, if the chosen unit is the RPM, SPEED_UNIT is defined to 60,
 * since 1 Hz is 60 RPM.
 *
 * @note This symbol should not be set to a literal numeric value. Rather, it
 ...
 * angle (uses more MIPS)
 *
 *        to use a circle limitation that keeps Vdq angle uncomment the define
