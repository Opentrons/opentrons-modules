...
auto HeaterPolicy::set_thermal_offsets(flash::OffsetConstants* constants)
    ...
    to_send.const_flag = static_cast<uint64_t>(flash::Flash::FLASHFlag::WRITTEN_NO_CHECKSUM);
...
auto HeaterPolicy::get_thermal_offsets() -> flash::OffsetConstants {
    ...
    if (to_receive.const_flag == (static_cast<uint64_t>(flash::Flash::FLASHFlag::WRITTEN_NO_CHECKSUM))) {
        to_pass.flag = true;
    }
    return to_pass;
}
