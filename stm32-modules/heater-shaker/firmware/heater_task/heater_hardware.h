...
#define HEATER_PAD_SHORT_CHECK_THRESHOLD \
    (HEATER_PAD_OPEN_CHECK_PULSE *       \
     HEATER_PAD_SHORT_CHECK_THRESHOLD_FACTOR)  // 20% of pwm period
#define HEATER_PAD_SHORT_CHECK_PULSE \
    (HEATER_PAD_OPEN_CHECK_PULSE *   \
     HEATER_PAD_SHORT_CHECK_PULSE_FACTOR)  // 60% of pwm period
#define HEATER_PAD_OPEN_CIRCUIT_DAC_THRESHOLD 0x00000F8U  // roughly 0.2V
#define HEATER_PAD_SHORT_CIRCUIT_DAC_THRESHOLD 0x000009B1U  // roughly 2V
