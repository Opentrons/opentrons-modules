...
#define HEATER_PAD_OPEN_CHECK_PULSE (HEATER_PAD_PWM_GRANULARITY / HEATER_PAD_OPEN_CHECK_PULSE_DIVIDER) // 10% of pwm period
#define HEATER_PAD_OPEN_CHECK_THRESHOLD_FACTOR 2uL
#define HEATER_PAD_OPEN_CHECK_THRESHOLD (HEATER_PAD_OPEN_CHECK_PULSE * HEATER_PAD_OPEN_CHECK_THRESHOLD_FACTOR) // 20% of pwm period
#define HEATER_PAD_SHORT_CHECK_THRESHOLD_FACTOR 8uL
#define HEATER_PAD_SHORT_CHECK_PULSE_FACTOR 9uL
#define HEATER_PAD_SHORT_CHECK_THRESHOLD (HEATER_PAD_OPEN_CHECK_PULSE * HEATER_PAD_SHORT_CHECK_THRESHOLD_FACTOR) // 80% of pwm period
#define HEATER_PAD_SHORT_CHECK_PULSE (HEATER_PAD_OPEN_CHECK_PULSE * HEATER_PAD_SHORT_CHECK_PULSE_FACTOR) // 90% of pwm period
...
#define HEATER_PAD_CIRCUIT_CHECK_PERIOD 2000uL // count incremented twice per tick, so period is half this value (in ticks)
