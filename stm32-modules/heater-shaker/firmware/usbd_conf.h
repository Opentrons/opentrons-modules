...
// malloc and free are used by some of the usbd class implementations; we're not using
// them, and therefore these should never be called, but defining them this way should
// give reasonably legible compiler failures if they are so we know where the problem is
