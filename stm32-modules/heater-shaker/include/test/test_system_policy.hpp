...
class TestSystemPolicy {
  public:
    ...
    /*auto set_serial_number(std::array<char, system_serial_number_length> new_system_serial_number) 
        -> errors::ErrorCode;
    ...
    std::copy(copy_start, (copy_start + copy_length), system_serial_number.begin());
