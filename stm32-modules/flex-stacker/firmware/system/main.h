...
#define TOF_EN_X_PIN GPIO_PIN_12
#define TOF_EN_X_PORT GPIOC
#define TOF_EN_Z_PIN GPIO_PIN_4
#define TOF_EN_Z_PORT GPIOB

#define HOPPER_DOOR_CLOSED_PIN GPIO_PIN_13
#define HOPPER_DOOR_CLOSED_GPIO_PORT GPIOC
