...
#define USBD_PRODUCT_HS_STRING        "Reference HS" /* Add your product High Speed string */
#define USBD_PRODUCT_FS_STRING        "Reference FS" /* Add your product Full Speed string */
