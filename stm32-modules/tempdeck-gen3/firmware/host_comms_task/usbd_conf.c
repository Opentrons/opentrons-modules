...
//
// The structure is copied from an STM32G491 project generated by STM32CubeMX. All
// of the following is below the level of the USB class and is identical for all
// device classes.
