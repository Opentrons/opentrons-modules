...
build-tempdeck:
	echo "compiler.cpp.extra_flags=-DTD_FW_VERSION=\"NEW_OFFSET_TEST_VER\"" > $(ARDUINO15_LOC)/packages/Opentrons/hardware/avr/$(OPENTRONS_BOARDS_VER)/platform.local.txt
